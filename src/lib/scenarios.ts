    ...
    choices: [
      {
        ...
        effects: { wealthDelta: 18, controlDelta: 12, allianceDelta: -15, stratificationDelta: 12, productionDelta: -3 },
      },
      {
        id: 'B',
        text: 'Chuyển sang mô hình hợp tác xã — nông dân đồng sở hữu nền tảng, chia lợi nhuận',
        effects: { wealthDelta: -3, controlDelta: -8, allianceDelta: 20, stratificationDelta: -10, productionDelta: 12 },
      },
      {
        id: 'C',
        text: 'Giữ hoa hồng 10% cố định, đầu tư lợi nhuận vào đào tạo kỹ năng số cho nông dân',
        effects: { wealthDelta: 5, controlDelta: 5, allianceDelta: 10, stratificationDelta: -5, productionDelta: 8 },
      },
    ],
  },
    ...
    choices: [
      {
        ...
        effects: { wealthDelta: 12, controlDelta: 8, allianceDelta: -12, stratificationDelta: 15, productionDelta: 0 },
      },
      {
        id: 'B',
        text: 'Ủng hộ thuế + đầu tư nhà ở xã hội — chấp nhận thiệt hại ngắn hạn vì công bằng',
        effects: { wealthDelta: -8, controlDelta: 3, allianceDelta: 18, stratificationDelta: -12, productionDelta: 8 },
      },
      {
        id: 'C',
        text: 'Đề xuất mô hình nhà ở hợp tác xã — cộng đồng cùng xây, cùng quản lý, giá hợp lý',
        effects: { wealthDelta: 0, controlDelta: 10, allianceDelta: 15, stratificationDelta: -8, productionDelta: 6 },
      },
    ],
  },
    ...
    choices: [
      {
        ...
        effects: { wealthDelta: 8, controlDelta: -15, allianceDelta: -5, stratificationDelta: 8, productionDelta: 10 },
      },
      {
        id: 'B',
        text: 'Xây dựng nền tảng công lập mã nguồn mở — chậm hơn nhưng bảo vệ chủ quyền dữ liệu',
        effects: { wealthDelta: -5, controlDelta: 18, allianceDelta: 15, stratificationDelta: -8, productionDelta: 8 },
      },
      {
        id: 'C',
        text: 'Cho phép cạnh tranh tự do — ai muốn dùng gì thì dùng, thị trường tự điều chỉnh',
        effects: { wealthDelta: 5, controlDelta: 0, allianceDelta: -3, stratificationDelta: 10, productionDelta: 5 },
      },
    ],
  },
    ...
    choices: [
      {
        ...
        effects: { wealthDelta: 15, controlDelta: 10, allianceDelta: -10, stratificationDelta: 15, productionDelta: 5 },
      },
      {
        id: 'B',
        text: 'Dừng AI, mời đoàn kiểm toán độc lập đánh giá thiên kiến — chấp nhận chậm lại',
        effects: { wealthDelta: -5, controlDelta: 5, allianceDelta: 15, stratificationDelta: -10, productionDelta: 3 },
      },
      {
        id: 'C',
        text: 'Dùng AI hỗ trợ nhưng giữ con người ra quyết định cuối — kết hợp hiệu quả và công bằng',
        effects: { wealthDelta: 5, controlDelta: 8, allianceDelta: 8, stratificationDelta: -3, productionDelta: 8 },
      },
    ],
  },
    ...
    choices: [
      {
        ...
        effects: { wealthDelta: 10, controlDelta: -12, allianceDelta: -8, stratificationDelta: 12, productionDelta: 8 },
      },
      {
        id: 'B',
        text: 'Từ chối — giữ nguyên hệ thống hành chính truyền thống, công nghệ chưa đủ tin cậy',
        effects: { wealthDelta: 0, controlDelta: 8, allianceDelta: 5, stratificationDelta: 3, productionDelta: -3 },
      },
      {
        id: 'C',
        text: 'Mô hình kết hợp — DAO để giám sát minh bạch, con người vẫn ra quyết định phân bổ',
        effects: { wealthDelta: 3, controlDelta: 10, allianceDelta: 12, stratificationDelta: -5, productionDelta: 10 },
      },
    ],
  },
    ...
    choices: [
      {
        ...
        effects: { wealthDelta: 10, controlDelta: 5, allianceDelta: -15, stratificationDelta: 12, productionDelta: 3 },
      },
      {
        id: 'B',
        text: 'Ủng hộ hoàn toàn — UBI là quyền cơ bản, bảo đảm nhân phẩm trong kỷ nguyên AI',
        effects: { wealthDelta: -8, controlDelta: -3, allianceDelta: 20, stratificationDelta: -15, productionDelta: 5 },
      },
      {
        id: 'C',
        text: 'Đề xuất UBI có điều kiện — gắn với đào tạo nghề hoặc đóng góp cộng đồng',
        effects: { wealthDelta: 0, controlDelta: 8, allianceDelta: 10, stratificationDelta: -5, productionDelta: 10 },
      },
    ],
  },
]
